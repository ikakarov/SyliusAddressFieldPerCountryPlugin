...
final class GreetingController extends Controller
{
    ...
    {
        return $this->render('@VanssaAddressFieldPerCountryPluginExtension/static_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }
    ...
    {
        return $this->render('@VanssaAddressFieldPerCountryPluginExtension/dynamic_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }
